			...
			<div class="container">
				...
				<div class="questionSection">
					...
					<div class="mainSection">
						<div class="pull-left">
							<div class="question">
								<p>What is printed by the following code fragment? </p>
							</div>
							<div class="questionCode">
								<pre>int[] a = {0,1,2,3,4,5,6};
System.out.println(a.length); 
						...
						<div class="pull-right">
							<ul class="answers">
								<li class="answer1">6</li>
								<li class="answer2">8</li>
								<li class="answer3">7</li>
								<li class="answer4">5</li>
							</ul>
						</div>
					</div>
				</div>
		...
		<script src="arraysEx1Answers.js"></script>
	</body>
</html>