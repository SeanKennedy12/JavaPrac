			...
			<div class="container">
				...
				<div class="questionSection">
					<div class="header">
						...
						<div class="pull-left">
							<div class="question">
								<p>What is in the list nums if it initially contained {5, 3, 1} and <br> the following code is executed?</p>
							</div>
...
nums.remove(1);
						...
						<div class="pull-right">
							<ul class="answers">
								<li class="answer1">[5, 3, 1, 6]</li>
								<li class="answer2">[5, 3, 6]</li>
								<li class="answer3">[4, 3, 6]</li>
								<li class="answer4">[4, 3, 1, 6]</li>
							</ul>
						</div>
					</div>
				</div>
