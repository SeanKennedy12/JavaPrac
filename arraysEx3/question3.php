			...
			<div class="container">
				...
				<div class="questionSection">
					<div class="header">
						...
						<div class="pull-left">
							<div class="question">
								<p>What are the contents of arr after the following code has been executed?</p>
							</div>
							<div class="questionCode">
								<pre>int[][] arr = {{3,2,1},{1,2,3}};
int value = 0;
    	...
    	if (value % 2 == 1) {
      	...
      	if (arr[row][col] % 2 == 0) {
       		arr[row][col] = value * 2;
						...
						<div class="pull-right">
							<ul class="answers">
								<li class="answer1">{{6, 4, 2}, {2, 4, 6}}</li>
								<li class="answer2">{{4, 4, 2}, {2, 4, 4}}</li>
								<li class="answer3">{{3, 2, 1}, {1, 4, 8}}</li>
								<li class="answer4">{{3, 2, 1}, {2, 4, 4}}</li>
							</ul>
						</div>
					</div>
				</div>
