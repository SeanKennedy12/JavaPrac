<?php
	...
	require("./connect.php");
	$exercise1Result = mysql_query("SELECT `exercise status` FROM Scores WHERE `exercise name`='arrays' && `exercise number`=1 && `username`='$username'");
	...
	$exercise2Result = mysql_query("SELECT `exercise status` FROM Scores WHERE `exercise name`='arrays' && `exercise number`=2 && `username`='$username'");
	...
	$exercise3Result = mysql_query("SELECT `exercise status` FROM Scores WHERE `exercise name`='arrays' && `exercise number`=3 && `username`='$username'");
		...
		<div class="exercises">
			<div class="container">
				...
				<div class="exerciseSection">
					<a href="arraysEx1/question1.php">
						<div class="exercise">
							<div class="pull-left">
								<h3>Exercise 1:</h3>
								<p>Easy exercise on Arrays & ArrayLists</p>
							</div>
					...
					<a href="arraysEx2/question1.php">
						<div class="exercise">
							<div class="pull-left">
								<h3>Exercise 2:</h3>
								<p>Medium exercise on Arrays & ArrayLists</p>
							</div>
							<div class="pull-right">
					...
					<a href="arraysEx3/question1.php">
						<div class="exercise">
							<div class="pull-left">
								<h3>Exercise 3:</h3>
								<p>Hard exercise on Arrays & ArrayLists</p>
							</div>
							<div class="pull-right">
