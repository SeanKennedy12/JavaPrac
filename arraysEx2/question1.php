			...
			<div class="container">
				...
				<div class="questionSection">
					<div class="header">
						...
						<div class="pull-left">
							<div class="question">
								<p>Which of method of ArrayList class is used to obtain present size of an object?</p>
							</div>
						...
						<div class="pull-right">
							<ul class="answers">
								<li class="answer1">size()</li>
								<li class="answer2">length()</li>
								<li class="answer3">index()</li>
								<li class="answer4">capacity()</li>
							</ul>
						</div>
					</div>
				</div>
