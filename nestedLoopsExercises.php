<?php
	...
	require("./connect.php");
	$exercise1Result = mysql_query("SELECT `exercise status` FROM Scores WHERE `exercise name`='nestedLoops' && `exercise number`=1 && `username`='$username'");
	...
	$exercise2Result = mysql_query("SELECT `exercise status` FROM Scores WHERE `exercise name`=nestedLoops' && `exercise number`=2 && `username`='$username'");
	...
	$exercise3Result = mysql_query("SELECT `exercise status` FROM Scores WHERE `exercise name`='nestedLoops' && `exercise number`=3 && `username`='$username'");
...
<html>
	...
	<body>
		...
		<div class="exercises">
			<div class="container">
				<div class="header">
					<h2>Nested Loop exercises:</h2>
				</div>
				
				<div class="exerciseSection">
					<a href="nestedLoopsEx1/question1.php">
						<div class="exercise">
							<div class="pull-left">
								<h3>Exercise 1:</h3>
								<p>Easy exercise on nested loops</p>
							</div>
					...
					<a href="#">
						<div class="exercise">
							<div class="pull-left">
								<h3>Exercise 2:</h3>
								<p>Medium exercise on nested loops</p>
							</div>
							<div class="pull-right">
					...
					<a href="#">
						<div class="exercise">
							<div class="pull-left">
								<h3>Exercise 3:</h3>
								<p>Hard exercise on nested loops</p>
							</div>
							<div class="pull-right">
